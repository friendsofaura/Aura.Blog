...
class BlogEditActionTest extends \PHPUnit_Framework_TestCase
{
    protected $action;
    ...
    public function setUp()
    {
        ...
        $responder = $di->get('aura/blog:web_responder_blog_edit');
        ...
        $this->action = new BlogEditAction(
            $request,
            $domain,
            $responder
        );
    ...
    public function test__Invoke()
    {
        ...
        $this->assertInstanceOf('Aura\Blog\Web\Responder\BlogEditResponder', $actual);
    }
}
