<?php
namespace Aura\Blog\Web;

use Aura\Web\Response;
use Aura\View\View;
use Aura\Web\Request\Accept;
use Aura\Blog\Domain\Result\ResultInterface;
...
abstract class AbstractResponder
{
    ...
    {
        $status = $this->result->get('status');
        $this->response->status->set('500');
        $this->response->content->set("Unknown domain result status: '$status'");
        return $this->response;
    }
